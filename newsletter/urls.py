...
urlpatterns = [
    ...
    path(
        "<newsletter_slug>/", NewsletterDetailView.as_view(), name="newsletter_detail"
    ),
    ...
    path(
        ...
        name="newsletter_update_activate",
    ),
    path(
    ...
    path(
        ...
        SubmissionArchiveDetailView.as_view(),
        name="newsletter_archive_detail",
    ),
    path(
        "<newsletter_slug>/archive/",
        SubmissionArchiveIndexView.as_view(),
